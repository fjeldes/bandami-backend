...
-- Wrapped in DO block so it doesn't fail on fresh DBs where tables
-- haven't been created yet (migration 000 may run later).
DO $$ BEGIN
...
EXCEPTION WHEN undefined_table THEN
    RAISE NOTICE 'user_dashboard_stats view skipped — underlying tables not ready yet';
END $$;
